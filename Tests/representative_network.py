...
def main(repeater_delay_multiplier, avg_send_time, total_sim_packets):
    ...
    print("Node 0 nextRp:", nodes[0].nextRp)
    print("Node 1 nextRp:", nodes[1].nextRp)
    print("Node 2 nextRp:", nodes[2].nextRp)
    print("Node 3 nextRp:", nodes[3].nextRp)
    print("Node 4 nextRp:", nodes[4].nextRp)
    print("Node 5 nextRp:", nodes[5].nextRp)
    print("Node 6 nextRp:", nodes[6].nextRp)
    print("Node 7 nextRp:", nodes[7].nextRp)
    print("Node 8 nextRp:", nodes[8].nextRp)
    print("Node 9 nextRp:", nodes[9].nextRp)
    print("Node 10 nextRp:", nodes[10].nextRp)
    print("Node 11 nextRp:", nodes[11].nextRp)
    print("Node 12 nextRp:", nodes[12].nextRp)
    print("Node 13 nextRp:", nodes[13].nextRp)
    print("Node 14 nextRp:", nodes[14].nextRp)
    print("Node 15 nextRp:", nodes[15].nextRp)
    print("Node 16 nextRp:", nodes[16].nextRp)
    print("Node 17 nextRp:", nodes[17].nextRp)
    print("Node 18 nextRp:", nodes[18].nextRp)
